...
public class IcsLinearLayout extends LinearLayout {
    ...
    public IcsLinearLayout(Context context, int themeAttr) {
        super(context);
        init(context,null,themeAttr);
    }

    private void init(Context context, AttributeSet attributeSet, int themeAttr){
        TypedArray a = context.obtainStyledAttributes(attributeSet, LL, themeAttr, 0);
